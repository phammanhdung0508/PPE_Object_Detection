...
from protos import detector_pb2 as protos_dot_detector__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in protos/detector_pb2_grpc.py depends on'
...
def add_DetectorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'protos.DetectorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('protos.DetectorService', rpc_method_handlers)
